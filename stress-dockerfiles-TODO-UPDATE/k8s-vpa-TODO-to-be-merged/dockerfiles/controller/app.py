...
def metrics(hostname: str):
    global WORKLOADS, CURRENT_TIME_STEP, SERVICES, IS_ENABLED_SCHEDULER, INTERVAL
...
def updateTimesteps():
    ...
    try:
        for hostname, detail in SERVICES.items():
            ...
            # TODO: we have to ignore second argument, beacause of removing DISK
            CPU, RAM = WORKLOADS.data[:, CURRENT_TIME_STEP]
